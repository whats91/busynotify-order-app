...
export class OrderRepository {
  ...
  async create(
    ...
    customerId: string,
    customerName: string,
    customerSalesmanId: string | undefined,
    customerSalesmanName: string | undefined,
    customerSalesmanMobileNumber: string | undefined,
    customerSalesmanWhatsappNumber: string | undefined,
    ...
    const response = await fetch('/api/internal/orders', {
      ...
      body: JSON.stringify({
        ...
        customerSalesmanMobileNumber,
        customerSalesmanWhatsappNumber,
        customerState,
        companyState,
        saleTypeId,
        saleTypeName,
