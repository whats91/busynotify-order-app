  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      const result = await orderService.createOrder({
        ...
        customerSalesmanId: activeCustomerRecord?.salesmanId,
        customerSalesmanName: activeCustomerRecord?.salesmanName,
        customerSalesmanMobileNumber: activeCustomerRecord?.salesmanMobileNumber,
        customerSalesmanWhatsappNumber: activeCustomerRecord?.salesmanWhatsappNumber,
